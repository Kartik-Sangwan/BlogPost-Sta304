...
# creating plots for better visual grasp
...
#ggplot(covid_time_series, aes (x = `Number of Cases`)) + labs( title = "Number of COVID cases Overtime", xlab = "Dates from Jan to Sept 23rd", ylab = "Number of cases") +  geom_histogram()  +theme_bw()+theme(plot.title = element_text(hjust = 0.5))
...
```{r}
# converting the dates in numerical x values assuming.
...
ggplot(covid_time_series, aes(x = diff, y = `Number of Cases`, color = as.factor(phase))) +        geom_point() +  
